...
import renderTasksToDom from "./tasks-dom.js"
import tasksData from "./tasks-data.js"

//import all the functionality we need to process the task section
        ...
        tasksData.getIncompleteTasks(userId)
            .then(allTasks => {
                ...
                allTasks.forEach(task => {
                    ...
                    renderTasksToDom.tasksToDom(taskHtml)
                })
            })
    },
